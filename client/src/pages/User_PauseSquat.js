  ...
  loadUser = () => {
    ...
    API.getUser(this.props.match.params.id)
      .then(res => {
        ...
        var pauseSquatOneRMArrayBW = convertTo1RMBW(this.state.pause_squat, pauseSquatOneRMArray);
    ...
    return (
      <Container fluid>
        <Row>
          ...
          <MyWindowPortal>
          <h2>Pause Squat Progress Relative to BW (y2, pounds) compared to Squat progress Relative to BW (y1, pounds per day)</h2>
          <ResponsiveContainer width='99%' height={500} >
          <LineChart
