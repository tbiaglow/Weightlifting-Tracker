  ...
  loadUser = () => {
    ...
    API.getUser(this.props.match.params.id)
      .then(res => {
        ...
        var rackPullOneRMArrayBW = convertTo1RMBW(this.state.rack_pull, rackPullOneRMArray);
        ...
        var rackPullDataBW = createArray(this.state.rack_pull, rackPullOneRMArrayBW);
        var dataToGraph = arrayEqualize(deadliftData, rackPullData);
        var dataToGraphBW = arrayEqualize(deadliftDataBW, rackPullDataBW);
    ...
    return (
      <Container fluid>
        <Row>
          ...
          <MyWindowPortal>
          <h2>Rack Pull Progress Relative to BW (y2, pounds) compared to Deadlift progress Relative to BW (y1, pounds per day)</h2>
          <ResponsiveContainer width='99%' height={500} >
          <LineChart
